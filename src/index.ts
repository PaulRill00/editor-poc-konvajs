...
const presavedJson = localStorage.getItem('konva-json');
const stage = presavedJson 
  ? Konva.Node.create(presavedJson, 'container')
  : new Konva.Stage({
  container: "container",
  width: design.width,
...
const bounds = new Bounds(stage);
const editor = new Editor(stage, bounds);
